    ...
    <div class="register-box">
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <div class="text-left mt-3 d-flex align-items-center">
                    <p class="text-muted small mb-0 mr-1">Already have an account?</p>
                    <a href="{{ url('login') }}" class="text-primary small text-decoration-none">Sign in</a>
                </div>
            </div>
        </div>
    </div>
